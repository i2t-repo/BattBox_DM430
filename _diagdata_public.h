/**
   ...
   Copyright &copy; 2015 Danfoss. All rights reserved.
 ...
 */
/*lint -save -e960 -e961 Code violates MISRA rules 19.12 and 19.13 ('#' and '##'). We have not other choice than to suppress. */
#ifdef __cplusplus
...
/** Declare \a _ApplDiagInfo that contains the user diagnostic data
*/
...
/** Data structure for user diagnostic data must not comply to naming convention
*/
typedef struct
{
